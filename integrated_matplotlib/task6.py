...
def task6():
    ...
    def ellipse(major_axis, eccentricity, name, color):
        ...
        ax.plot(tracex, tracey, label=name, color=color)
    ...
    def animate(frame):
        ...
        ax.plot(posx, posy, linewidth=0.25, color="black", )
    ...
    ax.set(xlabel="x/AU", ylabel='y/AU', title="Solar system Spirograph! :D")
    plt.xlabel("x/AU")
    plt.ylabel("y/AU")
    # plt.grid()
    # plt.show()
